...
function executeReportQuery() {
  ...
  const underwritingData = [
    { ref: "POL-MOT-JAN01", holder: "Josphat Kamau", cat: "Motor Comprehensive", lob: "Motor Comprehensive", date: "2026-01-10", branch: "HQ", sumInsured: 2500000, premium: 125000 },
    { ref: "POL-FIRE-JAN02", holder: "Nakuru Agro Millers", cat: "Fire & Perils", lob: "Fire & Perils", date: "2026-01-15", branch: "Nakuru", sumInsured: 40000000, premium: 600000 },
    { ref: "POL-MAR-JAN03", holder: "Mombasa Tea Exporters", cat: "Marine Cargo", lob: "Marine Cargo", date: "2026-01-20", branch: "Mombasa", sumInsured: 15000000, premium: 225000 },
    { ref: "POL-FLEET-FEB01", holder: "Kisumu Fish Distributors", cat: "Motor Commercial Fleet", lob: "Motor Commercial", date: "2026-02-05", branch: "Kisumu", sumInsured: 8000000, premium: 400000 },
    { ref: "POL-ENG-FEB02", holder: "Eldoret Highway Builders", cat: "Engineering All Risks", lob: "Engineering", date: "2026-02-12", branch: "Eldoret", sumInsured: 50000000, premium: 750000 },
    { ref: "POL-MOT-FEB03", holder: "Grace Nyambura", cat: "Motor Private", lob: "Motor Comprehensive", date: "2026-02-20", branch: "HQ", sumInsured: 1200000, premium: 60000 },
    { ref: "POL-FIRE-MAR01", holder: "Nairobi Grains Depot", cat: "Fire & Perils", lob: "Fire & Perils", date: "2026-03-08", branch: "HQ", sumInsured: 60000000, premium: 900000 },
    { ref: "POL-MAR-MAR02", holder: "Mombasa Import Logistics", cat: "Marine Cargo", lob: "Marine Cargo", date: "2026-03-14", branch: "Mombasa", sumInsured: 30000000, premium: 450000 },
    { ref: "POL-FLEET-MAR03", holder: "Nakuru Dairies Fleet", cat: "Motor Commercial Fleet", lob: "Motor Commercial", date: "2026-03-22", branch: "Nakuru", sumInsured: 12000000, premium: 600000 },
    { ref: "POL-ENG-APR01", holder: "Lake Victoria Water Board", cat: "Engineering All Risks", lob: "Engineering", date: "2026-04-06", branch: "Kisumu", sumInsured: 120000000, premium: 1800000 },
    { ref: "POL-MOT-APR02", holder: "David Kipkorir", cat: "Motor Private", lob: "Motor Comprehensive", date: "2026-04-18", branch: "Eldoret", sumInsured: 1600000, premium: 80000 },
    { ref: "POL-FIRE-APR03", holder: "Mombasa Port Warehouses", cat: "Fire & Perils", lob: "Fire & Perils", date: "2026-04-25", branch: "Mombasa", sumInsured: 95000000, premium: 1425000 },
    { ref: "POL-FLEET-MAY01", holder: "Nairobi Courier Services", cat: "Motor Commercial Fleet", lob: "Motor Commercial", date: "2026-05-04", branch: "HQ", sumInsured: 10000000, premium: 500000 },
    { ref: "POL-MAR-MAY02", holder: "Eldoret Flower Exporters", cat: "Marine Cargo", lob: "Marine Cargo", date: "2026-05-15", branch: "Eldoret", sumInsured: 8000000, premium: 120000 },
    { ref: "POL-MOT-MAY03", holder: "Stephen Ochieng", cat: "Motor Private", lob: "Motor Comprehensive", date: "2026-05-28", branch: "Kisumu", sumInsured: 2000000, premium: 100000 },
    { ref: "POL-FIRE-JUN01", holder: "Nakuru Timber Millers", cat: "Fire & Perils", lob: "Fire & Perils", date: "2026-06-03", branch: "Nakuru", sumInsured: 35000000, premium: 525000 },
    { ref: "POL-ENG-JUN02", holder: "Nairobi Tech Park Project", cat: "Engineering All Risks", lob: "Engineering", date: "2026-06-12", branch: "HQ", sumInsured: 150000000, premium: 2250000 },
    { ref: "POL-FLEET-JUN03", holder: "Coast Petrol Haulers", cat: "Motor Commercial Fleet", lob: "Motor Commercial", date: "2026-06-22", branch: "Mombasa", sumInsured: 40000000, premium: 2000000 },
    { ref: "POL-MAR-JUL01", holder: "Kisumu Port Authority", cat: "Marine Cargo", lob: "Marine Cargo", date: "2026-07-07", branch: "Kisumu", sumInsured: 20000000, premium: 300000 },
    { ref: "POL-MOT-JUL02", holder: "Ezekiel Kemboi", cat: "Motor Private", lob: "Motor Comprehensive", date: "2026-07-15", branch: "Eldoret", sumInsured: 2800000, premium: 140000 },
    { ref: "POL-FIRE-JUL03", holder: "Nairobi Industrial Park", cat: "Fire & Perils", lob: "Fire & Perils", date: "2026-07-26", branch: "HQ", sumInsured: 200000000, premium: 3000000 },
  ...
  const claimsData = [
    { ref: "CLM-2026-JAN01", claimant: "Josphat Kamau", polRef: "POL-MOT-JAN01", lob: "Motor Comprehensive", date: "2026-01-18", branch: "HQ", amount: 120000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-JAN02", claimant: "Nakuru Agro Millers", polRef: "POL-FIRE-JAN02", lob: "Fire & Perils", date: "2026-01-28", branch: "Nakuru", amount: 1800000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-FEB01", claimant: "Kisumu Fish Distributors", polRef: "POL-FLEET-FEB01", lob: "Motor Commercial", date: "2026-02-14", branch: "Kisumu", amount: 450000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-MAR01", claimant: "Mombasa Import Logistics", polRef: "POL-MAR-MAR02", lob: "Marine Cargo", date: "2026-03-20", branch: "Mombasa", amount: 950000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-MAR02", claimant: "Nakuru Dairies Fleet", polRef: "POL-FLEET-MAR03", lob: "Motor Commercial", date: "2026-03-29", branch: "Nakuru", amount: 350000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-APR01", claimant: "David Kipkorir", polRef: "POL-MOT-APR02", lob: "Motor Comprehensive", date: "2026-04-22", branch: "Eldoret", amount: 85000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-MAY01", claimant: "Nairobi Courier Services", polRef: "POL-FLEET-MAY01", lob: "Motor Commercial", date: "2026-05-18", branch: "HQ", amount: 220000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-MAY02", claimant: "Eldoret Flower Exporters", polRef: "POL-MAR-MAY02", lob: "Marine Cargo", date: "2026-05-24", branch: "Eldoret", amount: 130000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-JUN01", claimant: "Coast Petrol Haulers", polRef: "POL-FLEET-JUN03", lob: "Motor Commercial", date: "2026-06-29", branch: "Mombasa", amount: 1500000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-JUL01", claimant: "Ezekiel Kemboi", polRef: "POL-MOT-JUL02", lob: "Motor Comprehensive", date: "2026-07-22", branch: "Eldoret", amount: 95000, status: "Paid / Settled", statusType: "approved" },
    { ref: "CLM-2026-JUL02", claimant: "Nairobi Industrial Park", polRef: "POL-FIRE-JUL03", lob: "Fire & Perils", date: "2026-07-30", branch: "HQ", amount: 4500000, status: "Under Assessment", statusType: "pending" },
...
// === AUTOMATIC GLOBAL WINDOW BINDINGS (BUILT BY BINDER) ===
window.initThemeControl = initThemeControl;
...
window.getFraudClass = getFraudClass;
window.renderDashboardChart = renderDashboardChart;
window.resetFNOLStepper = resetFNOLStepper;
window.setupFNOLStepper = setupFNOLStepper;
window.updateFNOLStepperView = updateFNOLStepperView;
window.validateFNOLStep = validateFNOLStep;
window.saveFNOLClaim = saveFNOLClaim;
window.runANPRScanSimulation = runANPRScanSimulation;
window.initFNOLMap = initFNOLMap;
window.detectUserLocation = detectUserLocation;
window.updateMapResourceContext = updateMapResourceContext;
window.setupCanvasAnnotator = setupCanvasAnnotator;
window.setDrawTool = setDrawTool;
window.resizeAnnotationCanvas = resizeAnnotationCanvas;
window.redrawCanvas = redrawCanvas;
window.runAICoreAudit = runAICoreAudit;
window.setupClaimsDirectory = setupClaimsDirectory;
window.renderClaimsDirectory = renderClaimsDirectory;
window.getStatusClass = getStatusClass;
window.exportClaimsCSV = exportClaimsCSV;
window.exportClaimsJSON = exportClaimsJSON;
window.setupModalHandlers = setupModalHandlers;
window.openAuditModal = openAuditModal;
window.initModalMap = initModalMap;
window.printKIRADocument = printKIRADocument;
window.setupAlertsSimulator = setupAlertsSimulator;
window.onAlertContextChange = onAlertContextChange;
window.triggerAlertTelegramDispatch = triggerAlertTelegramDispatch;
window.renderAlertsSimulator = renderAlertsSimulator;
window.selectAlertTab = selectAlertTab;
window.populateAlertPreviews = populateAlertPreviews;
window.setupPolicyRegistry = setupPolicyRegistry;
window.openNewPolicyModal = openNewPolicyModal;
window.closeNewPolicyModal = closeNewPolicyModal;
window.calculateModalPolicyPremium = calculateModalPolicyPremium;
window.confirmCreateNewPolicy = confirmCreateNewPolicy;
window.triggerCertPolicy = triggerCertPolicy;
window.generateCertSHA256Hash = generateCertSHA256Hash;
window.openAKICertModal = openAKICertModal;
window.verifyCertIntegrityAudit = verifyCertIntegrityAudit;
window.simulateTamperAttempt = simulateTamperAttempt;
window.closeAKICertModal = closeAKICertModal;
window.simulatePoliceQRScan = simulatePoliceQRScan;
window.saveToMobileWallet = saveToMobileWallet;
window.downloadDigitalCertPDF = downloadDigitalCertPDF;
window.triggerSTKPushCheckout = triggerSTKPushCheckout;
window.closeSubscriptionCheckoutModal = closeSubscriptionCheckoutModal;
window.confirmSTKPushPayment = confirmSTKPushPayment;
window.updateSubscriptionUI = updateSubscriptionUI;
window.openUserSeatAllocationModal = openUserSeatAllocationModal;
window.closeUserSeatModal = closeUserSeatModal;
window.addNewUserSeat = addNewUserSeat;
window.switchMobileAppMode = switchMobileAppMode;
window.onWorkshopGarageChange = onWorkshopGarageChange;
window.navigateToWorkshopApp = navigateToWorkshopApp;
window.calcWorkshopTotal = calcWorkshopTotal;
window.updateWorkshopComponentFields = updateWorkshopComponentFields;
window.submitWorkshopRepairRequest = submitWorkshopRepairRequest;
window.renderScheduledPayouts = renderScheduledPayouts;
window.openSchedulePaymentModal = openSchedulePaymentModal;
window.closeSchedulePaymentModal = closeSchedulePaymentModal;
window.onSchedClaimSelectChange = onSchedClaimSelectChange;
window.confirmSchedulePayment = confirmSchedulePayment;
window.releaseScheduledPayoutNow = releaseScheduledPayoutNow;
window.cancelScheduledPayout = cancelScheduledPayout;
window.renderPolicyRegistry = renderPolicyRegistry;
window.triggerDebitPolicy = triggerDebitPolicy;
window.toggleSuspendPolicy = toggleSuspendPolicy;
window.cancelPolicy = cancelPolicy;
window.setupProductionReports = setupProductionReports;
window.renderProductionReports = renderProductionReports;
window.triggerProductionAISynthesis = triggerProductionAISynthesis;
window.openRenewalModal = openRenewalModal;
window.closeRenewalModal = closeRenewalModal;
window.toggleAllRenewalCheckboxes = toggleAllRenewalCheckboxes;
window.dispatchRenewalNotices = dispatchRenewalNotices;
window.openAIAssistantModal = openAIAssistantModal;
window.setupAIAssistant = setupAIAssistant;
window.processAIQuery = processAIQuery;
window.generateAIReportSynthesis = generateAIReportSynthesis;
window.escapeHTML = escapeHTML;
window.exportAIBriefPDF = exportAIBriefPDF;
window.renderGarageNetwork = renderGarageNetwork;
window.assignGarageClaim = assignGarageClaim;
window.renderMpesaGateway = renderMpesaGateway;
window.updateClaimPayoutChannel = updateClaimPayoutChannel;
window.executeChannelPayout = executeChannelPayout;
window.renderLossAssessors = renderLossAssessors;
window.dispatchAssessor = dispatchAssessor;
window.calc3ReinsurerRiskSplit = calc3ReinsurerRiskSplit;
window.openReinsuranceCalculatorModal = openReinsuranceCalculatorModal;
window.closeReinsuranceCalculatorModal = closeReinsuranceCalculatorModal;
window.updateModalReinsCalc = updateModalReinsCalc;
window.applyReinsuranceSharesToLedger = applyReinsuranceSharesToLedger;
window.renderReinsuranceCeding = renderReinsuranceCeding;
window.renderMobileAppPortal = renderMobileAppPortal;
window.downloadAppPackage = downloadAppPackage;
window.installPWAApp = installPWAApp;
window.renderIRACompliance = renderIRACompliance;
window.exportIRAReturnForm = exportIRAReturnForm;
window.renderSubrogationRecovery = renderSubrogationRecovery;
window.issueSubrogationNotice = issueSubrogationNotice;
window.renderFleetUnderwriting = renderFleetUnderwriting;
window.batchIssueFleetCerts = batchIssueFleetCerts;
window.simulateFleetCSVUpload = simulateFleetCSVUpload;
window.lockMapView = lockMapView;
window.renderGeoMapCenter = renderGeoMapCenter;
window.filterGeoMapMarkers = filterGeoMapMarkers;
window.closeEditModal = closeEditModal;
window.openEditClaim = openEditClaim;
window.openEditPolicy = openEditPolicy;
window.openEditGarage = openEditGarage;
window.openEditAssessor = openEditAssessor;
window.openEditReinsurance = openEditReinsurance;
window.openEditSubrogation = openEditSubrogation;
window.openEditFleetVehicle = openEditFleetVehicle;
window.openEditIRATaxRates = openEditIRATaxRates;
window.saveEditedRecord = saveEditedRecord;
window.closeCameraModal = closeCameraModal;
window.openCameraCaptureModal = openCameraCaptureModal;
window.loadHighResDemoPhoto = loadHighResDemoPhoto;
window.autoFillDemoClaimData = autoFillDemoClaimData;
window.quickSubmitDemoClaim = quickSubmitDemoClaim;
window.renderVehicleLossRatios = renderVehicleLossRatios;
window.applyHighRiskRateLoadings = applyHighRiskRateLoadings;
window.adjustModelLoading = adjustModelLoading;
window.onEVModelSelectChange = onEVModelSelectChange;
window.calculateEVPremium = calculateEVPremium;
window.resetEVForm = resetEVForm;
window.issueEVPolicyCertificate = issueEVPolicyCertificate;
window.renderRemoteStaffTable = renderRemoteStaffTable;
window.triggerRemotePulseCheck = triggerRemotePulseCheck;
window.toggleWFHMode = toggleWFHMode;
window.viewRemoteTelemetry = viewRemoteTelemetry;
window.renderPesaFlowTransactionsTable = renderPesaFlowTransactionsTable;
window.openECitizenSSOModal = openECitizenSSOModal;
window.closeECitizenSSOModal = closeECitizenSSOModal;
window.confirmECitizenSSO = confirmECitizenSSO;
window.runECitizenNTSASync = runECitizenNTSASync;
window.openPesaFlowModal = openPesaFlowModal;
window.closePesaFlowModal = closePesaFlowModal;
window.confirmPesaFlowPayment = confirmPesaFlowPayment;
window.viewPesaFlowReceipt = viewPesaFlowReceipt;
window.renderITaxRemittanceTable = renderITaxRemittanceTable;
window.openITaxFilingModal = openITaxFilingModal;
window.closeITaxFilingModal = closeITaxFilingModal;
window.confirmITaxFiling = confirmITaxFiling;
window.runETIMSBulkSync = runETIMSBulkSync;
window.viewITaxReceipt = viewITaxReceipt;
window.renderLPRScansTable = renderLPRScansTable;
window.onLPRFormatChange = onLPRFormatChange;
window.triggerLPRLiveFeedScan = triggerLPRLiveFeedScan;
window.simulateAllKenyanPlates = simulateAllKenyanPlates;
window.viewLPREXIFMedia = viewLPREXIFMedia;
window.renderStandardQRCodeContainer = renderStandardQRCodeContainer;
window.loadQRPreset = loadQRPreset;
window.updateTestQRCode = updateTestQRCode;
window.renderNTSAPoliceVerifiedBadge = renderNTSAPoliceVerifiedBadge;
window.simulateNTSAPoliceScan = simulateNTSAPoliceScan;
window.downloadNTSAPoliceBadge = downloadNTSAPoliceBadge;
window.downloadQRCodePNG = downloadQRCodePNG;
window.copyQRPayload = copyQRPayload;
window.openTestQRScannerModal = openTestQRScannerModal;
window.closeTestQRScannerModal = closeTestQRScannerModal;
window.simulateQRScanTrigger = simulateQRScanTrigger;
window.renderNotificationDispatchTable = renderNotificationDispatchTable;
window.loadNotificationLogToPhone = loadNotificationLogToPhone;
window.openCameraModal = openCameraModal;
window.closeNativeCameraModal = closeNativeCameraModal;
window.triggerDeviceCameraCapture = triggerDeviceCameraCapture;
window.handleCapturedPhotoUpload = handleCapturedPhotoUpload;
window.takeLiveCameraPhotoSnap = takeLiveCameraPhotoSnap;
...
window.saveRecordedVideoTelemetry = saveRecordedVideoTelemetry;
window.syncCapturedMediaToANPR = syncCapturedMediaToANPR;
window.triggerANPRFileUpload = triggerANPRFileUpload;
window.handleANPRFileUpload = handleANPRFileUpload;
window.saveMediaToVault = saveMediaToVault;
window.renderSavedMediaVault = renderSavedMediaVault;
window.selectStoredMediaItem = selectStoredMediaItem;
window.downloadActiveClaimMedia = downloadActiveClaimMedia;
window.uploadActiveClaimMediaToCloud = uploadActiveClaimMediaToCloud;
window.applyReportPeriodPreset = applyReportPeriodPreset;
window.executeReportQuery = executeReportQuery;
window.exportQueriedReport = exportQueriedReport;
window.setReportChartType = setReportChartType;
